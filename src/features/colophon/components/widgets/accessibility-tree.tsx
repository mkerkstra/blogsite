  ...
  return (
    <WidgetFrame label="accessibility tree" caption="semantic html → screen reader nav">
      ...
      >
        ...
        <line x1="100" y1="18" x2="60" y2="34" stroke="currentColor" opacity="0.4" />
        <line x1="120" y1="18" x2="160" y2="34" stroke="currentColor" opacity="0.4" />
        <rect
          x="135"
          y="34"
          width="50"
        ...
        <line x1="45" y1="48" x2="28" y2="64" stroke="currentColor" opacity="0.4" />
        <line x1="60" y1="48" x2="75" y2="64" stroke="currentColor" opacity="0.4" />
        <line x1="70" y1="48" x2="130" y2="64" stroke="currentColor" opacity="0.4" />
        <rect
          x="8"
          y="64"
          width="40"
