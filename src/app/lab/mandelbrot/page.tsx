    ...
    <>
      ...
      <Mandelbrot
        info={
          <>
            <p>
              For each pixel, map its screen coordinates to a complex number c and iterate z = z*z +
              c starting from z = 0. If the magnitude of z exceeds 2, the point has escaped and lies
              outside the Mandelbrot set. Points that never escape are inside the set and render
              black. The set&apos;s boundary has infinite perimeter but encloses finite area, a
              fractal with <Term id="hausdorff-dimension">Hausdorff dimension</Term> 2.
            </p>
            <p>
            ...
            <p>
              Rendered in a single <Term id="fragment-shader">fragment shader</Term> on the GPU.
              Every pixel evaluates the iteration loop independently, making the Mandelbrot set
              embarrassingly parallel and ideal for GPU computation. Zooming multiplies the maximum
              iteration count because finer structure near the boundary needs more iterations to
              resolve. Deep zooms eventually hit the precision limit of 32-bit floats, around 10^7x
              magnification, where the image pixelates.
            </p>
            <p>
