      ...
      <Sorting
        info={
          <>
            ...
            <p>
              The O(n log n) algorithms achieve this bound by different strategies: quicksort
              partitions around a pivot, mergesort divides and conquers with a stable merge step,
              heapsort maintains a binary heap invariant, and shellsort uses diminishing gap
              sequences to move elements long distances early. The O(n&#178;) algorithms are simpler
              but degrade with scale, doing redundant work on every pass.
            </p>
            <p>
            ...
            <p>
              ...
              sort. Nearly-sorted input is a best case for insertion sort (nearly linear) but a
              worst case for naive quicksort (quadratic without median-of-three pivot selection).
              Each bar is one element. The counter tracks comparisons and swaps. Same input,
