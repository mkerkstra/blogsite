...
export default function SpectrePage() {
  return (
    <>
      <LabHead slug="spectre" />
      <Spectre
        info={
          <>
            <p>
              For over sixty years, mathematicians asked the{" "}
              <Term id="einstein-problem">einstein problem</Term>: does a single shape exist that
              tiles the plane but only in a non-repeating way? Penrose tilings (1974) achieved{" "}
              <Term id="aperiodic-tiling">aperiodic tiling</Term> with two shapes. The hat tile
              (March 2023) brought it down to one, but required mirror flips. The spectre tile,
              published months later by Smith, Myers, Kaplan, and Goodman-Strauss, is the first true{" "}
            ...
            <p>
              ...
              rotations and translations, never flips. The resulting pattern provably never repeats:
            ...
            <p>
              ...
              generate the tiling. A small seed cluster is recursively inflated: at each level,
              every tile is replaced by a group of smaller copies arranged according to fixed rules.
              After several iterations, the hierarchy produces a tiling that covers the visible
              area. Colors encode which metatile role each spectre plays in the substitution, making
              the recursive structure visible.
            </p>
            <p>
              ...
              complexity without repetition. Pan and zoom to explore the structure at different
              scales.
            </p>
